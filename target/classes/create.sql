...
create table seat (row_num integer, seat_id integer not null auto_increment, seat_number integer, theater_id bigint, status varchar(255), primary key (seat_id)) engine=InnoDB;
...
create table ticket (price float(53) not null, seat_id integer, screening_id bigint, ticket_id bigint not null auto_increment, seat_number varchar(255), status enum ('Available','Booked','Cancelled'), primary key (ticket_id)) engine=InnoDB;
